...
if __name__ == "__main__":
    ...
    while True:
        ...
        if key == ord('q'): #press "q" to quit the program
            ...
            cv2.imwrite('frame_' + current_time + '_.png', last_frame)
        elif key == ord('t'):
        ...
        e2 = cv2.getTickCount() #used for tracking performance
        time_running = (e2 - e1) / cv2.getTickFrequency()
        print(time_running)
        
    cap.release()
    cv2.destroyAllWindows() #stops recording and deletes all windows
